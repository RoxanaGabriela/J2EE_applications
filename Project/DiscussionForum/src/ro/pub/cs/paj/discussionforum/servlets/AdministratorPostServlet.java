...
public class AdministratorPostServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try (PrintWriter printWriter = new PrintWriter(response.getWriter())) {	
			...
			AdministratorPostGraphicUserInterface.displayAdministratorGraphicUserInterface(username, posts,
					comments, (currentRecordsPerPage != null) ? Integer.parseInt(currentRecordsPerPage)
