package ro.pub.cs.paj.discussionforum.graphicinterface;
...
public class LoginGraphicInterface {
	
	public LoginGraphicInterface() {}
	...
	public static void displayLoginGraphicUserInterface(boolean isLoginError, PrintWriter printWriter) {
		...
		content.append("        <link rel=\"stylesheet\" type=\"text/css\" href=\"css/discussionForum.css\" />\n");
