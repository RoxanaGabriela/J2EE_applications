...
public class AdministratorPostGraphicUserInterface {
	...
	public static void displayAdministratorPostGraphicUserInterface(String username, List<Post> posts,
			int currentRecordsPerPage, int currentPage, PrintWriter printWriter) {
		...
		content.append("		<form action=\"" + Constants.ADMINISTRATOR_POST_SERVLET_PAGE_CONTEXT + "\" method=\"post\" name=\"" + Constants.ADMINISTRATOR_POST_FORM + "\">\n");
		...
		for (int index = 0; index < posts.size(); index++) {
			...
			content.append("												<tbody>\n");
			content.append("													<tr>\n");
			content.append("														<td style=\"text-align: left;\">User: " + posts.get(index).getClientUsername() + "</td>\n");
			content.append("													</tr>\n");
			content.append("													<tr>\n");
			content.append("														<td style=\"text-align: left;\">Date:" + posts.get(index).getDate() + " " + posts.get(index).getTime() + "</td>\n");
			content.append("													</tr>\n");
			content.append("													<tr>\n");
			content.append("														<td style=\"text-align: left;\">Title:" + posts.get(index).getTitle() + "</td>\n");
			content.append("													</tr>\n");
			content.append("													<tr>\n");
