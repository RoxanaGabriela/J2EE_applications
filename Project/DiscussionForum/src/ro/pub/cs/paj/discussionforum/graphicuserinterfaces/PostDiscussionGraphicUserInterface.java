...
public class PostDiscussionGraphicUserInterface {
	public PostDiscussionGraphicUserInterface() {
	}

	public static void displayPostDiscussionGraphicUserInterface(String username, boolean loggedIn, Post post,
		...
		content.append("		<form action=\"" + Constants.POSTDISCUSSION_SERVLET_PAGE_CONTEXT + "\" method=\"post\" name=\"" + Constants.POST_FORM + "\">\n");
		...
		content.append("												<tbody>\n");
		content.append("													<tr>\n");
		content.append("														<td style=\"text-align: center;\">" + post.getClientUsername() + "</td>\n");
		content.append("													</tr>\n");
		content.append("													<tr>\n");
		content.append("														<td style=\"text-align: center;\">" + post.getTitle() + "</td>\n");
		content.append("													</tr>\n");
		content.append("													<tr>\n");
		content.append("														<td style=\"text-align: center;\">" + post.getDescription() + "</td>\n");
		content.append("													</tr>\n");
		content.append("												</tbody>\n");
		content.append("											</table>\n");
		content.append("										</td>\n");
		...
		for (int index = 0; index < comments.size(); index++) {
			...
			content.append("												<tbody>\n");
			content.append("													<tr>\n");
			content.append("														<td style=\"text-align: center;\">" + comments.get(index).getClientUsername() + "</td>\n");
			content.append("													</tr>\n");
			content.append("													<tr>\n");
			content.append("														<td style=\"text-align: center;\">" + comments.get(index).getDescription() + "</td>\n");
			content.append("													</tr>\n");
			content.append("												</tbody>\n");
			content.append("											</table>\n");
			content.append("										</td>\n");
